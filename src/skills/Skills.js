...
import jsImage from './../assets/image/js-png.png'
        ...
        <div id='skills' className={style.skillsBlock}>
            ...
            {/*<div className={`${style.container} ${style.skillsContainer}`}>*/}
                ...
                <div className={style.skills}>
                    <Skill image={js} title={'JS'} description={'some text about JS'}/>
                    <Skill image={css} title={'CSS'} description={'some text about CSS'}/>
